...
<div class="inside">
Hi, admin |
<form action="./home.php" method ="POST" target="hiddenFrame" name="hack">
<table class="table1">
<tr>
...
<td>
<input class="updatename left" name="fname" placeholder="&#xf007  First Name" value="Phoenix" type="text" required>
</td>
</tr>
<tr>
<td><label for="lname">Last Name </label></td>
<td><input class="updatepass" name="lname" placeholder="&#xf007  Last Name" value="Joaquin" type="text" required></td>
</tr>
<tr>
